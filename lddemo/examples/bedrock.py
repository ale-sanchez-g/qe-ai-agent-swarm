...
def main():
    ...
    # random string based on random array
    array = ["user-1", "user-2", "user-3", "user-4"]
    ...
    print(f"*** AI Prompts: {config_value.messages[0].content}")
    ...
    print(f"*** Using model: {config_value.model.name}")
    print(f"*** Total messages: {len(config_value.messages)}")
