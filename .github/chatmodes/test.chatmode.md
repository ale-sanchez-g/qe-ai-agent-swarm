---
description: Use this agent to execute a set of test using the Playwright MCP tool and file system search tools.
tools: ['search/fileSearch', 'search/textSearch', 'search/listDirectory', 'search/readFile', 'Playwright/*', 'todos']
---
